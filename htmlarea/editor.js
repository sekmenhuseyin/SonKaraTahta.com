...
//
// A free WYSIWYG editor replacement for <textarea rows="1" cols="20"> fields.
...
function editor_action(button_id) {
  ...
  // smileys
    ...
    var myText=window.showModalDialog(_editor_url + "popups/smiley_select.html",
...
function editor_setmode(objname, mode) {
  ...
  var TextEdit  ='<textarea ID="_' +objname + '_editor" style="width:' +editor_obj.style.width+ '; height:' +editor_obj.style.height+ '; margin-top: -1px; margin-bottom: -1px;" rows="1" cols="20"></textarea>';
...
// still working on this      + ' oncontextmenu="parent.editor_cMenu_generate(window,\'' +objname+ );"'
      +'>'
      + contents
      + '</body>\n'
      + '</html>\n';
