...
<body bgcolor="C1D8EE" link="#0000FF" vlink="#0000FF" alink="#0000FF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="toForm()">
  ...
  <center>
    <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img src="sendmessage.gif" width="150" height="35"></font></strong> 
    <br />
    <b><font size="2" face="Arial, Helvetica, sans-serif">Kime</font></b><br />
    <table width="220" border="0" bgcolor="#5996D2">
      <tr>
        <td>
          <div align="center"><font color="white"><b><font face="Arial, Helvetica, sans-serif"><%=application("" & newid & "")%> 
            <input name="recipid" type="hidden" id="recipid" value="<%=request("id")%>">
            </font></b></font></div>
        </td>
      </tr>
    </table>
...
<div align="center">
            <input name="id" type="hidden" id="id" value="<%=application("" & fromid & "")%>">
