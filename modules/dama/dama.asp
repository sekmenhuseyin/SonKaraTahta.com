...
if (cnt==1 && autosolve)
{
if (confirm(' Şimdi Sıra Sende....'))
newGame();
}
else if (cnt==1 && pos[24]==1)
{
finished=true;
if (confirm('oyun bitti tekrar oynayacakmısın?')) newGame();
}
else if (cnt==1)
{
finished=true;
...
"<OPTION VALUE=\"Fireplace\">Şömine\n"+
"<OPTION VALUE=\"Up Arrow\">Yukarı Ok\n"+
"<OPTION VALUE=\"Pyramid\">Piramit\n"+
"<OPTION VALUE=\"Diamond\">Baklava\n"+
"<OPTION SELECTED VALUE=\"Solitaire\">Tek Boşluklu\n"+
"</SELECT>\n"+
"</FORM>\n"+
"<P>\n"+
