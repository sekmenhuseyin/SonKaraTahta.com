...
SQL_L="Select * from fotograf where kategori ='" & kat &"' ORDER by fno asc"
...
If Toplam_Kayit=0 Then
	...
	<br />
	<br />
	<font face="Verdana"><a href='javascript:history.go(-1);'><- Geri</a>
<%Else
...
<table width="100%" cellspacing="0" cellpadding="10" align="center">
  ...
  <tr>
    <%for i=0 to 3%>
    <td width="20%"><% if page_bilgi < msg_sayisi then %>
      <div align="center"> <a href="javascript:void window.open('modules/gallery/show.asp?menu=show&imgid=<%=liste("fno")%>','','width=350,height=700,scrollbars=2')"><img src="<%=liste("kucuk")%>" width=120 height=200 border="0"></a><br />
        <font face="Arial, Helvetica, sans-serif" size="1"><%=liste("hit")%> </font> <font face="Verdana" size="1"><b>/ <%=liste("tarih")%> / <%=liste("isim")%> / <a href="modules.asp?name=<%=Request.QueryString("name")%>&menu=yorum&imgid=<%=liste("fno")%>"> Yorum Ekle</a></b></font></div>
...
set Connection=nothing
 %>
  <br />
  <font face="Verdana"><a href='javascript:history.go(-1);'><- Geri</a></font>
</center>
...
if islem="" then %>
<% sec_code=CPASS(4)
Session("EnterSecurityCode")=sec_code %>
<div align="center">
<center>
...
<table height='100%' align='center'>
  <tr>
    <td align='center'><font size="2">Ýletiniz Kaydedildi.<br />
      Onaylandýktan sonra eklenecektir.<br />
      </font><a href='?name=<%=Request.QueryString("name")%>'><font size="2">Geri</font></a></td>
  </tr>
</table>
"
<% end sub %>
...
<table height='100%' align='center'>
  <tr>
    <td align="center"><font size="2">Hata! Ýsim belirtmediniz.<br />
      </font><a href="javascript:history.go(-1);"><font size="2">Düzelt</font></a></td>
  </tr>
</table>
<% end sub %>
<%
...
<table cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber1">
  <tr>
    <td width="100%" colspan="3"><p align="center"><b>Kategoriler</b></td>
  </tr>
  <% do while not liste.eof %>
  <tr>
    <td width="34%" align="center"><% if kayitsayi < msg_sayisi then %>
      <img src="Images/stats/over.gif">&nbsp<font size="2" color="#000000"><a href="?name=<%=Request.QueryString("name")%>&menu=category&kat=<%=liste("kategori")%>"><%=liste("kategori")%></a><br />
      </font><font size="2"><%=liste("statement")%></font>
      <%  kayitsayi=kayitsayi+1
liste.movenext %>
      &nbsp;</td>
    <% else %>
