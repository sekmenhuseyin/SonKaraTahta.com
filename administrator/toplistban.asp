...
response.write "<font face=verdana size=1>Yayýnlanan Banner Yok !</font>"
end if
Do while not rs.eof %>
<tr><td bgcolor="#F4F4F4" width="91">
  <img src="<%=rs("resurl")%>" width="88" height="31"></td>
  <td align="center" bgcolor="#F4F4F4" width="138"><a href="?action=duzenle&bid=<%=rs("banid")%>">Düzenle</a> - <a href="?action=sil&bid=<%=rs("banid")%>">Sil</a><br></td></tr>
<% rs.MoveNext
Loop %>
</table>
<%
...
<tr><td colspan="2" width="264"><input type="submit" value="Güncelle" class="submit" style="width: 100%"></td></tr>
